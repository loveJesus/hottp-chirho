...
const RAW_REVIEW_GUIDANCE_SNIPPETS_CHIRHO = [
  ...
  "Use this when the red box itself is wrong",
  "Split the red-box row",
  "Drag red box",
  "Draft red box x",
  "Drag the red box or its side handles",
  "Save draft repair proposal records a draft only.",
  "target-span-marker-chirho",
  "rebox-handle-chirho",
  "Save draft repair proposal",
  "Geometry OK",
  "How to review this item",
  "Current text (red box)",
  "Your correction (optional - only when the print differs)",
  "Keyboard: Ctrl/Command+Enter saves when the action requirements are satisfied",
  "review-column-chirho",
  "focus-magnify-chirho",
  "line-confidence-certain-chirho",
  "line-confidence-borderline-chirho",
  "line-confidence-questionable-chirho",
  "do not retype text. Check the Segmentation issue box or file a segment repair proposal below",
  ...
  "Current text codepoints",
  "Correction codepoints",

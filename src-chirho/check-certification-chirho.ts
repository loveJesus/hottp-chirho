...
const CHECK_COMMANDS_CHIRHO: CheckCommandChirho[] = [
  ...
  {
    labelChirho: "segment tiling edit guards",
  ...
  {
    labelChirho: "vision verdict backup hygiene",
    argsChirho: [process.execPath, "run", "check-vision-verdict-backup-hygiene-chirho"],
  },
  {
  ...
  {
    labelChirho: "review packet output hygiene",
  ...
  {
    labelChirho: "review server health source coverage",
    argsChirho: [process.execPath, "run", "check-review-server-health-source-coverage-chirho"],
  },
  {

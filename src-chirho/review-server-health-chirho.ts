...
const REVIEW_SERVER_SOURCE_FILES_BY_KEY_CHIRHO: Record<ReviewServerKeyChirho, readonly string[]> = {
  "raw-hebrew-chirho": [
    ...
    "src-chirho/human-review-ui-chirho/page-chirho.ts",
    "src-chirho/human-review-ui-chirho/scan-images-chirho.ts",
    "src-chirho/human-review-ui-chirho/styles-chirho.ts",
    "src-chirho/human-review-ui-chirho/types-chirho.ts",
    "src-chirho/human-review-ui-chirho/session-chirho.ts",
    "src-chirho/human-review-ui-chirho/repair-chirho.ts",
    "src-chirho/human-review-ui-chirho/render-chirho.ts",
    "src-chirho/human-review-ui-chirho/events-chirho.ts",
    ...
    "src-chirho/segment-tiling-edit-chirho.ts",
  ...
  "latin-symbol-chirho": [
    ...
    "src-chirho/d1-audit-fingerprint-chirho.ts",

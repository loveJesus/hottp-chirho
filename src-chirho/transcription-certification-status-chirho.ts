...
const SYRIAC_BLANK_TRANSCRIPTION_HANDOFF_CROP_PATH_CHIRHO = join(
  PROJECT_ROOT_CHIRHO,
  "spec-chirho",
  "metropoliluya-chirho",
  "syriac-v3-p0151-l010-s3-context-crop-2026-06-04-chirho.png"
);
const SYRIAC_BLANK_TRANSCRIPTION_HANDOFF_TARGET_CROP_PATH_CHIRHO = join(
  PROJECT_ROOT_CHIRHO,
  "spec-chirho",
  "metropoliluya-chirho",
...
interface BlankVisionTierHandoffChirho {
  ...
  handoffTargetCropPathChirho: string | null;
...
interface RawHebrewTriageSampleChirho {
  idChirho: string;
...
interface RawHebrewTriageSummaryChirho {
  ...
  withoutPreReviewNoteItemCountChirho: number;
...
function countExpertItemsByScriptSourceChirho(
  itemsChirho: Array<{ scriptChirho?: string; visionSourceChirho?: string }>
): Record<string, Record<string, number>> {
  const countsChirho: Record<string, Record<string, number>> = {};
  for (const itemChirho of itemsChirho) {
    const scriptChirho = itemChirho.scriptChirho ?? "missing-script-chirho";
    const sourceChirho = itemChirho.visionSourceChirho ?? "missing-source-chirho";
    countsChirho[scriptChirho] ??= {};
    countsChirho[scriptChirho][sourceChirho] = (countsChirho[scriptChirho][sourceChirho] ?? 0) + 1;
  }
  return countsChirho;
}
...
interface CertificationStatusChirho {
  ...
  visionTierChirho: {
    ...
    liveVisionScriptSourceCountsChirho: Record<string, Record<string, number>>;
    ...
    pendingVisionScriptSourceCountsChirho: Record<string, Record<string, number>>;
...
function rawHebrewPackItemReviewUrlChirho(itemChirho: RawHebrewPackItemChirho): string {
  ...
  const volumeChirho = itemVolumeChirho(itemChirho) ?? undefined;
  return rawHebrewReviewUrlChirho(
    itemChirho.validationStatusChirho,
    undefined,
    undefined,
...
function rawHebrewPreReviewNoteReviewStartUrlChirho(
  ...
  return itemChirho === null || itemKeyChirho === null
    ? null
    : rawHebrewReviewUrlChirho(undefined, undefined, undefined, itemKeyChirho, undefined, undefined, preReviewNoteFilterChirho);
}

function firstRawHebrewPreReviewReasonGapItemChirho(
  itemsChirho: RawHebrewPackItemChirho[],
  preReviewNotesChirho: Map<string, string> | null
): RawHebrewPackItemChirho | null {
  return [...itemsChirho]
    .filter((itemChirho) =>
      rawHebrewPreReviewMissingAttentionKindsChirho(
        itemChirho,
        rawHebrewPreReviewNoteForItemChirho(itemChirho, preReviewNotesChirho)
      ).length !== 0
    )
    .sort(compareRawHebrewPackQueueOrderChirho)[0] ?? null;
}

function rawHebrewPreReviewReasonGapReviewStartUrlChirho(
  itemsChirho: RawHebrewPackItemChirho[],
  preReviewNotesChirho: Map<string, string> | null
): string | null {
  const itemChirho = firstRawHebrewPreReviewReasonGapItemChirho(itemsChirho, preReviewNotesChirho);
  const itemKeyChirho = itemChirho === null ? null : rawHebrewPackItemKeyChirho(itemChirho);
  return itemChirho === null || itemKeyChirho === null
    ? null
...
function blankVisionTierHandoffArtifactPathsChirho(
  ...
  syriacBlankTranscriptionHandoffTargetCropPathChirho: string
): { documentPathChirho: string | null; cropPathChirho: string | null; targetCropPathChirho: string | null } {
  if (idChirho !== "v3-p0151-l010-s3") {
    return { documentPathChirho: null, cropPathChirho: null, targetCropPathChirho: null };
  }
  return {
    documentPathChirho: syriacBlankTranscriptionHandoffPathChirho,
    cropPathChirho: syriacBlankTranscriptionHandoffCropPathChirho,
    targetCropPathChirho: syriacBlankTranscriptionHandoffTargetCropPathChirho,
  };
}
...
function blankVisionTierHandoffRequiredDocumentSnippetsChirho(
  ...
  targetCropPathChirho: string | null,
  targetCropSha256Chirho: string | null,
  issueChirho: {
    volumeChirho: number;
    pageChirho: number;
    lineIndexChirho: number;
  ...
  if (targetCropPathChirho !== null) {
    snippetsChirho.push(`](${fileNameForPathChirho(targetCropPathChirho)})`);
  }
  if (targetCropSha256Chirho !== null) {
    snippetsChirho.push(`- Target crop SHA-256: \`${targetCropSha256Chirho}\``);
  }
  ...
  return issuesChirho
    ...
    .map((issueChirho) => {
      ...
      const artifactPathsChirho = blankVisionTierHandoffArtifactPathsChirho(
        ...
        syriacBlankTranscriptionHandoffTargetCropPathChirho
      );
      ...
      const requiredDocumentSnippetsChirho = blankVisionTierHandoffRequiredDocumentSnippetsChirho(
        ...
        artifactPathsChirho.targetCropPathChirho,
        handoffTargetCropSha256Chirho,
        issueChirho
      );
      ...
      return {
        ...
        handoffDocumentExistsChirho:
          artifactPathsChirho.documentPathChirho !== null && existsSync(artifactPathsChirho.documentPathChirho),
        ...
        handoffCropSha256Chirho,
        handoffTargetCropPathChirho: artifactPathsChirho.targetCropPathChirho,
        handoffTargetCropExistsChirho:
          artifactPathsChirho.targetCropPathChirho !== null && existsSync(artifactPathsChirho.targetCropPathChirho),
        handoffTargetCropSha256Chirho,
...
function markdownInlineCodeChirho(textChirho: string): string {
  return `\`${textChirho.replace(/`/g, "'")}\``;
}

function oneLineSnippetChirho(textChirho: string, maxLengthChirho: number): string {
...
function latinSymbolReviewRowsChirho(dbPathChirho: string): LatinSymbolReviewRowChirho[] {
  ...
  try {
    ...
    return rowsChirho.map((rowChirho) => {
      const issueFlagsChirho = parseStoredLatinSymbolIssueFlagsResultChirho(rowChirho.issue_flags_chirho);
      return {
        ...
        issueFlagsChirho: issueFlagsChirho.flagsChirho,
        issueFlagsShapeErrorChirho: issueFlagsChirho.shapeErrorChirho,
        notesChirho: rowChirho.notes_chirho,
        appliedAtChirho: rowChirho.applied_at_chirho,
        ...
        rowSourceChirho: "db-chirho" as const,
      };
    });
  } finally {
    dbChirho.close();
  ...
  return (backupChirho.reviewsChirho ?? [])
    .filter(
      (rowChirho) =>
        ...
        Array.isArray(rowChirho.issueFlagsChirho) &&
        rowChirho.issueFlagsChirho.every((flagChirho) => typeof flagChirho === "string") &&
        (rowChirho.issueFlagsShapeErrorChirho === undefined || rowChirho.issueFlagsShapeErrorChirho === null) &&
        (rowChirho.notesChirho === undefined || rowChirho.notesChirho === null || typeof rowChirho.notesChirho === "string") &&
    ...
    .map((rowChirho) => ({
      ...
      issueFlagsChirho: rowChirho.issueFlagsChirho!,
      issueFlagsShapeErrorChirho: rowChirho.issueFlagsShapeErrorChirho ?? null,
      notesChirho: rowChirho.notesChirho ?? null,
...
function reviewDurabilityKeyChirho(rowChirho: LatinSymbolReviewRowChirho): string {
  return [
    ...
    rowChirho.issueFlagsChirho.join("\u0001"),
    rowChirho.notesChirho ?? "",
    rowChirho.reviewerChirho,
...
function latinSymbolReviewRowSemanticErrorChirho(rowChirho: LatinSymbolReviewRowChirho): string | null {
  if (rowChirho.issueFlagsShapeErrorChirho !== null) {
    return `issue flags malformed: ${rowChirho.issueFlagsShapeErrorChirho}`;
  }
  if (rowChirho.verdictChirho === "accepted-clean-chirho") {
    if (!rowChirho.acceptCleanChirho) return "accepted-clean row lacks acceptCleanChirho acknowledgement";
    if (rowChirho.issueFlagsChirho.length !== 0) return "accepted-clean row carries issue flags";
    return null;
  }
  if (rowChirho.verdictChirho === "reviewed-issues-chirho") {
    if (rowChirho.acceptCleanChirho) return "reviewed-issues row carries acceptCleanChirho acknowledgement";
    if (rowChirho.issueFlagsChirho.length === 0) return "reviewed-issues row lacks issue flags";
    if (rowChirho.notesChirho === null || rowChirho.notesChirho.trim().length === 0) {
      return "reviewed-issues row lacks notesChirho";
    }
    return null;
  }
  return `unsupported verdict ${rowChirho.verdictChirho}`;
}
...
function summarizeLatinSymbolReviewsChirho(
  ...
  for (const rowChirho of schemaRowsChirho) {
    ...
    const semanticErrorChirho = latinSymbolReviewRowSemanticErrorChirho(rowChirho);
    if (semanticErrorChirho !== null) {
      invalidReviewRowsChirho += 1;
      continue;
    }
...
function validLatinSymbolReviewIdsChirho(
  ...
  for (const rowChirho of rowsChirho) {
    ...
    if (verdictChirho === "accepted-clean-chirho") {
      ...
      if (latinSymbolReviewRowSemanticErrorChirho(rowChirho) !== null) continue;
    }
...
interface BuildStatusOptionsChirho {
  ...
  visionTierExpertConfirmationPolicyPathChirho?: string;
  syriacBlankTranscriptionHandoffPathChirho?: string;
  syriacBlankTranscriptionHandoffCropPathChirho?: string;
  syriacBlankTranscriptionHandoffTargetCropPathChirho?: string;
}
...
function buildStatusChirho(dbPathChirho: string, optionsChirho: BuildStatusOptionsChirho = {}): CertificationStatusChirho {
  ...
  const visionTierExpertConfirmationPolicyPathChirho =
    optionsChirho.visionTierExpertConfirmationPolicyPathChirho ?? VISION_TIER_EXPERT_CONFIRMATION_POLICY_PATH_CHIRHO;
  ...
  const syriacBlankTranscriptionHandoffTargetCropPathChirho =
    optionsChirho.syriacBlankTranscriptionHandoffTargetCropPathChirho ??
    SYRIAC_BLANK_TRANSCRIPTION_HANDOFF_TARGET_CROP_PATH_CHIRHO;
  ...
  const visionTierExpertConfirmationPolicyExistsChirho = existsSync(visionTierExpertConfirmationPolicyPathChirho);
  ...
  const visionTierExpertConfirmationFileChirho = readVisionTierExpertConfirmationFileChirho(
    visionTierExpertConfirmationPolicyPathChirho
  );
  ...
  const visionTierChirho = {
    ...
    liveVisionScriptSourceCountsChirho: countExpertItemsByScriptSourceChirho(visionTierLiveItemsChirho),
    ...
    pendingVisionScriptSourceCountsChirho: countExpertItemsByScriptSourceChirho(pendingVisionTierLiveItemsChirho),
  ...
  const blankHandoffMissingDocumentCountChirho = structuralChirho.blankVisionTierHandoffsChirho.filter(
    (handoffChirho) => handoffChirho.handoffDocumentPathChirho === null || !handoffChirho.handoffDocumentExistsChirho
  ).length;
  const blankHandoffMissingCropCountChirho = structuralChirho.blankVisionTierHandoffsChirho.filter(
    (handoffChirho) =>
      handoffChirho.handoffCropPathChirho === null ||
      !handoffChirho.handoffCropExistsChirho ||
      handoffChirho.handoffTargetCropPathChirho === null ||
  ...
  if (latinSymbolReviewSummaryChirho.invalidReviewRowsChirho !== 0) {
    remainingWorkChirho.push(
      `${latinSymbolReviewSummaryChirho.invalidReviewRowsChirho} Latin/symbol review row(s) have malformed or verdict-inconsistent issue metadata`
    );
  }
  ...
  const reviewStartLinksChirho: Record<string, string | null> = {
    ...
    rawHebrewPreReviewReasonGapChirho: rawHebrewPreReviewReasonGapReviewStartUrlChirho(
      livePendingRawHebrewPackItemsChirho,
      rawHebrewPreReviewNotesChirho
    ),
    ...
    expertHebrewExplicitSpanSourceChirho: expertReviewStartUrlChirho(
      pendingExpertManifestItemsChirho,
      "hebrew-chirho",
      undefined,
      undefined,
    ...
    expertHebrewPassCOcrSourceChirho: expertReviewStartUrlChirho(
      pendingExpertManifestItemsChirho,
      "hebrew-chirho",
      undefined,
      undefined,
    ...
    expertHebrewD1DerivedSourceChirho: expertReviewStartUrlChirho(
      pendingExpertManifestItemsChirho,
      "hebrew-chirho",
      undefined,
      undefined,
    ...
    expertGreekExplicitSpanSourceChirho: expertReviewStartUrlChirho(
      pendingExpertManifestItemsChirho,
      "greek-chirho",
      undefined,
      undefined,
    ...
    expertGreekPassCOcrSourceChirho: expertReviewStartUrlChirho(
      pendingExpertManifestItemsChirho,
      "greek-chirho",
      undefined,
      undefined,
...
function rawHebrewAttentionHandoffMarkdownChirho(statusChirho: CertificationStatusChirho): string {
  ...
  return [
    ...
    `- Pre-review reason-gap lane: ${rawHebrewReviewUrlChirho(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, RAW_HEBREW_PRE_REVIEW_REASON_MISSING_CURRENT_CHIRHO)}`,
    "",
    "## Items",
    "",
    ...itemLinesChirho,
...
function markdownChirho(statusChirho: CertificationStatusChirho): string {
  ...
  const pendingExpertScriptSourceCountChirho = (scriptChirho: string, sourceChirho: string): number =>
    statusChirho.visionTierChirho.pendingVisionScriptSourceCountsChirho[scriptChirho]?.[sourceChirho] ?? 0;
  const expertScriptSourceCountChirho = (scriptChirho: string, sourceChirho: string): number =>
    statusChirho.visionTierChirho.liveVisionScriptSourceCountsChirho[scriptChirho]?.[sourceChirho] ?? 0;
  ...
  const blankVisionTierHandoffLinesChirho =
    statusChirho.structuralChirho.blankVisionTierHandoffsChirho.length === 0
      ...
      : statusChirho.structuralChirho.blankVisionTierHandoffsChirho.flatMap((handoffChirho) => [
          ...
          `  - Dedicated handoff target crop: \`${handoffChirho.handoffTargetCropPathChirho === null ? "missing-dedicated-handoff-target-crop-chirho" : relativeProjectPathChirho(handoffChirho.handoffTargetCropPathChirho)}\` (present: ${handoffChirho.handoffTargetCropExistsChirho})`,
          `  - Dedicated handoff target crop SHA-256: ${handoffChirho.handoffTargetCropSha256Chirho ?? "missing-target-crop-hash-chirho"}`,
  ...
  const rawHebrewAttentionLaneLinesChirho = [
    ...
    `- Raw Hebrew pre-review reason-gap lane: ${rawHebrewReviewUrlChirho(undefined, undefined, undefined, undefined, undefined, undefined, undefined, undefined, RAW_HEBREW_PRE_REVIEW_REASON_MISSING_CURRENT_CHIRHO)} (${statusChirho.rawHebrewChirho.triageChirho.preReviewReasonGapAttentionItemCountChirho} pending attention span(s) whose existing note misses current reason(s)${withReviewStartTextChirho(statusChirho.reviewStartLinksChirho.rawHebrewPreReviewReasonGapChirho)})`,
  ...
  return [
    ...
    "- Certification-affecting saves use the configured trusted server-side reviewer identity (`HOTTP_TRUSTED_REVIEWER_HEADER_CHIRHO`). If that env var is set and the trusted header is absent, writes fail closed; local `--reviewer` fallback is only for trusted local/dev sessions where the env var is unset. The browser reviewer field is display-only for stored attribution.",
    ...
    `- Expert Hebrew/WLC explicit-span lane: ${expertReviewUrlChirho("hebrew-chirho", undefined, undefined, undefined, undefined, "explicit-span-chirho")} (${pendingExpertScriptSourceCountChirho("hebrew-chirho", "explicit-span-chirho")} pending of ${expertScriptSourceCountChirho("hebrew-chirho", "explicit-span-chirho")} item(s)${withReviewStartTextChirho(statusChirho.reviewStartLinksChirho.expertHebrewExplicitSpanSourceChirho)})`,
    `- Expert Hebrew/WLC Pass-C OCR lane: ${expertReviewUrlChirho("hebrew-chirho", undefined, undefined, undefined, undefined, "pass-c-ocr-span-chirho")} (${pendingExpertScriptSourceCountChirho("hebrew-chirho", "pass-c-ocr-span-chirho")} pending of ${expertScriptSourceCountChirho("hebrew-chirho", "pass-c-ocr-span-chirho")} item(s)${withReviewStartTextChirho(statusChirho.reviewStartLinksChirho.expertHebrewPassCOcrSourceChirho)})`,
    `- Expert Hebrew/WLC D1-derived lane: ${expertReviewUrlChirho("hebrew-chirho", undefined, undefined, undefined, undefined, "d1-derived-chirho")} (${pendingExpertScriptSourceCountChirho("hebrew-chirho", "d1-derived-chirho")} pending of ${expertScriptSourceCountChirho("hebrew-chirho", "d1-derived-chirho")} item(s)${withReviewStartTextChirho(statusChirho.reviewStartLinksChirho.expertHebrewD1DerivedSourceChirho)})`,
    ...
    `- Invalid review rows: ${statusChirho.latinSymbolReviewDbChirho.invalidReviewRowsChirho}`,
...
function mainChirho(): void {
  ...
  const syriacBlankTranscriptionHandoffTargetCropPathChirho = parseArgValueChirho(
    argsChirho,
    "syriac-blank-handoff-target-crop-chirho"
  );
  const visionTierExpertConfirmationPolicyPathChirho = parseArgValueChirho(
    argsChirho,
    "expert-confirmation-policy-chirho"
  );

...
function markdownChirho(statusChirho: CertificationStatusChirho): string {
  ...
  return [
    ...
    "- Raw Hebrew clean certification: leave issue boxes unchecked only when letters, vowels/marks, accents, punctuation, segmentation, and script all match the print, then check the clean-certification acknowledgement before saving as clean.",
